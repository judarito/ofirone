...
const PRIMARY_TEXT_MODEL =
  process.env.EXPO_PUBLIC_PURCHASE_INVOICE_TEXT_MODEL
  || process.env.EXPO_PUBLIC_DEEPSEEK_TEXT_MODEL
  || 'deepseek-chat';
const FALLBACK_TEXT_EDGE_FUNCTION =
  process.env.EXPO_PUBLIC_PURCHASE_INVOICE_FALLBACK_EDGE_FUNCTION
  || process.env.EXPO_PUBLIC_OPENAI_TEXT_EDGE_FUNCTION
  || PRIMARY_TEXT_EDGE_FUNCTION;
const FALLBACK_TEXT_MODEL =
  process.env.EXPO_PUBLIC_PURCHASE_INVOICE_FALLBACK_MODEL
...
async function invokeLineNormalizer({
  edgeFunction,
  model,
  line,
}) {
