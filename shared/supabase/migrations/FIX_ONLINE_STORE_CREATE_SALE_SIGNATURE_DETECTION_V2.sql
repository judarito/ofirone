/* ============================================================================
   FIX_ONLINE_STORE_CREATE_SALE_SIGNATURE_DETECTION_V2.sql
   Versión forzada para instalaciones donde la primera corrección no se aplicó
   o to_regprocedure no resolvió la firma esperada.
   ============================================================================
*/
