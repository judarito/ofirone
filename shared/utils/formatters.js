/**
 * Utilidades de formateo de moneda y fechas.
 * Sin dependencias de framework — usable en web y mobile.
 *
 * El locale por defecto es 'es-CO' (Colombia).
 * En web, importar desde @/utils/formatters para usar el locale activo del i18n.
 */
...
/**
 * Formatea una fecha ISO como fecha + hora completa.
 * @param {string|Date} date
 * @param {string} [locale]
 * @returns {string}
 */
